...
export const SERVER_TOKEN_EXPIRETIME = process.env.SERVER_TOKEN_EXPIRETIME || '1m';
export const SERVER_TOKEN_REFRESH_EXPIRETIME = process.env.SERVER_TOKEN_REFRESH_EXPIRETIME || '120m';